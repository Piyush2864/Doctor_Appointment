...
export const callPatientSignupAPI = async () => {
  try {
...
export const callPatientLoginAPI = async () => {
  try {
    const response = await axios.post(
...
export const callGetPatientAPI = async () => {
...
export const callUpdatePatientAPI = async () => {
  const patientId = "your-patient-id"; // Replace with actual patient ID
  try {
...
export const callPatientHistoryAPI = async () => {
  const patientId = "your-patient-id"; // Replace with actual patient ID
  try {
    const response = await axios.get(
